...
**Linux/macOS:**
```bash
chmod +x backend/scripts/setup_ibm_tts.sh
./backend/scripts/setup_ibm_tts.sh
```
...
### Scripts
- ✅ `backend/scripts/setup_ibm_tts.ps1` - Windows setup (creates all profiles)
- ✅ `backend/scripts/setup_ibm_tts.sh` - Linux/macOS setup
- ✅ `backend/scripts/test_ibm_tts.py` - Test integration
...
3. **Test integration**: `python backend/scripts/test_ibm_tts.py`
...
2. Run the test: `python backend/scripts/test_ibm_tts.py`
